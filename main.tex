...
\begin{document}
    ...
    \input{parts/Chapter1.tex} %% Введение
    \newpage
    \input{parts/Chapter2.tex} %% Автоматическая векторизация программного кода
    \newpage
    \input{parts/Chapter3.tex} %% Обзор существующих решений
    \newpage
    \input{parts/Chapter4.tex} %% Компилятор Go
    \newpage
    \input{parts/Chapter5.tex} %% Проектирование SLP-векторизатора
    \newpage
    \input{parts/Chapter6.tex} %% Реализация
    \newpage
    \input{parts/Chapter7.tex} %% Экспериментальная оценка реализации
    \newpage
    \input{parts/Chapter8.tex} %% Заключение
    \newpage
